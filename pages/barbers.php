...
<html>
    <body>
        ...
        <div class='container mx-auto mt-5 col-12'>
                ...
                <div class="card card-bg col-md-6 mt-100">
                    <div class="card-content">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <img src="https://marketplace.canva.com/EAFHfL_zPBk/1/0/1600w/canva-yellow-inspiration-modern-instagram-profile-picture-kpZhUIzCx_w.jpg" alt="Barber Image" class="img-fluid shadow border-1">
                                </div>
                                <div class="col-md-8">
                                    <h4 class="text-center my-3">Kecske Béka</h4>
                                    <h5>Bemutatkozás</h5>
                                    <hr style="border-width: 1px; border-color: black">
                                    <h6>Sziasztok gyelekik</h6>
                                    <br>
                                    <h5>Skillek</h5>
                                    <hr style="border-width: 1px; border-color: black">
                                    <h6>Nincs</h6>
