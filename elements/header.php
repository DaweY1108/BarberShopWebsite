...
<html>
    <body class="body-bg">
        <nav class="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand text-light" href="?site=home"><i class="fa-solid fa-shop"></i> <?= $menuItems['title']; ?></a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-light" href="?site=login"><?= $menuItems['login']; ?> <i class="fa-solid fa-right-to-bracket"></i></a>
                    </li>
                </ul>
            </div>
        </nav>
